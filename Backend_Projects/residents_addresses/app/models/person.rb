...
class Person < ApplicationRecord
  ...
  class_name: :House
  # optional: true makes "belongs_to" association optional. Presence of :house is automatically being validated.

end

# Because Rails now automatically validates belongs_to associations, we don't want to explicitly add the validations ourselves. We don't want to do so because this puts us in a position where there will actually be two errors for the lack of a single association.
