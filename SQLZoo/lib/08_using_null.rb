...
def null_dept
	...
	# Hint: look to see which columns have "not null" constraints
	execute(<<-SQL)
		SELECT 
			name
		FROM	
...
def all_depts_join
	# Use a different JOIN so that all teacher and department names are listed.
