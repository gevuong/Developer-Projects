...
// import format packet to format text and print it out in console. Must be in double quotes, not single quotes. how to import multiple packages or libraries. You will encounter a "Compile Error: imported and not used" if you don't end up using a package you imported. Unlike other languages, you can accumulate unused library imports, so Go doesn't allow that, to reduce compilation time.
import (
	"fmt"
	"math"
